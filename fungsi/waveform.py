...
def psdplot(sta):
    ...
    st[0].plot(outfile='static/waveform/wform_'+sta+'_Z.jpg',dpi=100)
    st[1].plot(outfile='static/waveform/wform_'+sta+'_N.jpg',dpi=100)
    st[2].plot(outfile='static/waveform/wform_'+sta+'_E.jpg',dpi=100)
